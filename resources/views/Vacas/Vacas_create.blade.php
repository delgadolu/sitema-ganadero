						...
						<form method="POST" action="{{ route('Vacas.store') }}"  role="form">
							...
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										...
										<input type="text" name="edad_vaca" id="edad_vaca" class="form-control input-sm">
									</div>
								</div>
								<div class="col-xs-6 col-sm-6 col-md-6">
							...
							<div class="row">
								...
								<div class="col-xs-6 col-sm-6 col-md-6">
									...
									<div class="form-group">
										<input type="text" name="peso_pri_servi" id="peso_pri_servi" class="form-control input-sm">
									</div>
								</div>
							</div>
							<div class="row">
