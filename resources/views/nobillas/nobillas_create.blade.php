...
@section('page-css')
@section("titulo", "Registrar Novillas")
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">					
					<div class="table-container">
						<form method="POST" action="{{ route('nobillas.store') }}"  role="form" enctype="multipart/form-data">
							{{ csrf_field() }}
							<div class="row">
							...
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<label class="label">Nombre de la Novilla</label>
										<input type="text" name="nombre_nobilla" id="nombre_nobilla" class="form-control input-sm">
									</div>
								</div>
								<div class="col-xs-6 col-sm-6 col-md-6">	
									<div class="form-group">
										<label class="label">Edad de la Novilla</label>
										<input type="text" name="edad_nobilla" id="edad_nobilla" class="form-control input-sm">
									</div>
								</div>
							</div>		
								...
								<div class="input-group">
                                        <div class="custom-file-image">
                                            <input type="file"
                                                ...
                                                data-description="imagen de la Nobilla"
							...
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12">
                					...
                					<a class="btn btn-primary" href="{{route('nobillas.index')}}">Volver al listado</a>
								</div>	
							</div>
						</form>
					</div>
