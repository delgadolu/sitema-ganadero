					...
					<div class="table-container">
						<form method="POST" action="{{ route('Becerros.update',$Becerros->id) }}"  role="form">
							...
							<div class="row">
								...
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="fecha_nacim" id="fecha_nacim" class="form-control input-sm" value="{{$Becerros->fecha_nacim}}">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="nombre_becerro" id="nombre_becerro" class="form-control input-sm" value="{{$Becerros->edad_becerro}}">
									</div>
								</div>
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
							...
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="tipo_animal_id" id="tipo_animal_id" class="form-control input-sm" value="{{$Becerros->tipo_animal_id}}">
									</div>
								</div>
							</div>
							<div class="row">
